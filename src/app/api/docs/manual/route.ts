    ...
    sections: [
      {
        ...
        children: [
          ...
          subtitle("2.1 Obtenir un compte"),
          para("L'inscription libre est fermée : les comptes sont créés par l'administrateur de votre entreprise."),
          bullet("Demandez-lui la création de votre compte en lui indiquant votre nom et votre email professionnel"),
          bullet("Il choisit votre rôle : administrateur, inspecteur ou invité"),
          bullet("Vous recevez vos identifiants et vous connectez directement, sans étape de confirmation"),
          bullet("Le mot de passe doit contenir au minimum 8 caractères, une majuscule, une minuscule et un chiffre"),
          para("Si vous êtes administrateur, la création se fait depuis Administration puis Utilisateurs."),
          empty(),
          ...
          empty(),
          subtitle("2.3 Protéger son compte avec un second facteur"),
          para("Un second facteur ajoute, après le mot de passe, un code à six chiffres produit par une application sur votre téléphone. Il est vivement recommandé pour un compte administrateur, qui ouvre l'ensemble des chantiers et la gestion des utilisateurs."),
          bullet("Cliquez sur l'icône de bouclier dans la barre du haut, ou allez dans le menu puis « Sécurité du compte »"),
          bullet("Cliquez sur « Activer le second facteur »"),
          bullet("Scannez le code affiché avec une application d'authentification (Google Authenticator, Microsoft Authenticator, 1Password, Bitwarden…)"),
          bullet("Saisissez le code à six chiffres affiché par l'application pour confirmer"),
          para("Tant que ce premier code n'est pas saisi, rien ne change à votre connexion. Une fois confirmé, le code vous sera demandé à chaque connexion, juste après le mot de passe."),
          para("ATTENTION : si vous perdez le téléphone qui porte l'application, la reprise en main de votre compte demande une intervention technique sur la base de données. Enregistrez le compte dans un gestionnaire de mots de passe synchronisé, ou notez la clé de secours affichée au moment de l'activation."),
          empty(),
          subtitle("2.4 Tableau de bord"),
          ...
          // ===== 10. LIMITES PAR RÔLE =====
          new Paragraph({ children: [], pageBreakBefore: true }),
          title("10. Limites selon votre rôle"),
          para("Les fonctionnalités disponibles dépendent du rôle de votre compte."),
          empty(),
          subtitle("10.1 Invité"),
          ...
          empty(),
          subtitle("10.2 Inspecteur et administrateur"),
          bullet("Chantiers et visites illimités"),
          bullet("10 photos par visite"),
          bullet("Rapports PDF et envoi par email"),
          empty(),
          para("Le changement de rôle est effectué par un administrateur depuis la gestion des utilisateurs."),
