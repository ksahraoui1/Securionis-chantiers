...
export function UpgradeBanner({ message }: UpgradeBannerProps) {
  return (
    <div className="rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 flex items-start gap-3">
      <span translate="no" className="material-symbols-outlined text-blue-600 text-xl shrink-0 mt-0.5">lock</span>
      <div className="flex-1 min-w-0">
        ...
        >
          <span translate="no" className="material-symbols-outlined text-sm">upgrade</span>
